...
public class DocFxDoclet implements Doclet {
    ...
    public boolean run(DocletEnvironment environment) {
        if (repoMetadataFilePath == null) {
            repoMetadataFilePath = System.getProperty("repoMetadataFilePath");
        }
        if (artifactVersion == null) {
            artifactVersion = System.getProperty("artifactVersion");
        }
        if (librariesBomVersion == null) {
            librariesBomVersion = System.getProperty("librariesBomVersion");
        }
        if (outputPath == null) {
        ...
        if (disableChangelog) {
            disableChangelog = Boolean.parseBoolean(System.getProperty("disableChangelog"));
        }
        if (disableLibraryOverview) {
            disableLibraryOverview = Boolean.parseBoolean(System.getProperty("disableLibraryOverview"));
        }
