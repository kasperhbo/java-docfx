...
class ReferenceBuilder {
    ...
    private static final String            PRIMITIVE_URL  = "https://docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes.html";
    private static final String            JAVA_BASE_URL  = "https://docs.oracle.com/javase/11/docs/api/";
    ...
    void addPackageChildrenSummaries(
        ...
        for (TypeElement classElement : elementUtil.extractSortedElements(element)) {
            ...
            logger.debug("Adding package child summary for uid:{}, type:{}, summary:{}", uid, type, summary);
...
//
    ...
    private boolean isExternalReference(String uid) {
        return (false);
//            PROTOBUF_PATTERN.matcher(uid).find()
